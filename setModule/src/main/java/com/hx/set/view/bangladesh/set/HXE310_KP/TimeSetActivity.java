...
import com.hx.set.R;
import com.hx.set.contact.bangladesh.HXE310_KP.TimeSetContact;
import com.hx.set.presenter.bangladesh.HXE310_KP.TimeSetPresenter;
...
public class TimeSetActivity extends RxMvpBaseActivity<TimeSetContact.Presenter> implements TimeSetContact.View,OnDateSetListener {
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.set_function_time_set));
        ...
        timePickerDialog = new TimePickerDialog.Builder()
                ...
                .setSureStringId(getString(R.string.set_rote_confirm))
                .setTitleStringId(getString(R.string.time_picker))
                .setCallBack(this)
                .setThemeColor(ContextCompat.getColor(getInstance(), R.color.set_main_color))
                .build();
    }
