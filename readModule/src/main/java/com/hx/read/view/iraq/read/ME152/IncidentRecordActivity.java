package com.hx.read.view.iraq.read.ME152;
...
import com.hx.read.presenter.iraq.read.ME152.IncidentRecordPresenter;
...
public class IncidentRecordActivity extends RxMvpBaseActivity<IncidentRecordContact.Presenter> implements IncidentRecordContact.View{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(IncidentRecordActivity.this);
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.read_function_energy));
        ...
        headerLayout.showRightTextButton(ContextCompat.getColor(getInstance(), R.color.white), R.string.read_instantaneous_export, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (insList.size() > 0 && !StringUtil.isEmpty(insList.get(0).value)) {
                    if (mvpPresenter.saveData(insList, getString(R.string.read_function_energy))) {
    ...
    @Override
    public IncidentRecordContact.Presenter createPresenter() {
        return new IncidentRecordPresenter(this);
    }
