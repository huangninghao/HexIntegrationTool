...
import com.hx.read.contact.senegal.HXE310_KP.FreezeMonthContact;
import com.hx.read.presenter.senegal.HXE310_KP.FreezeMonthPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new HexRVBaseAdapter<TranXADRAssist>(this, freezeList, R.layout.item_freeze_list) {
            ...
            protected void convert(HexRVBaseViewHolder holder, TranXADRAssist item) {
                ...
                if (obis == ObisUtil.HXE115KP_METER_MONTH_FREEZE_PREPAID) {
