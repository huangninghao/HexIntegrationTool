...
import com.hx.read.contact.kyrgyzstan.northElectric.HXF300.OverVoltageContact;
import com.hx.read.presenter.kyrgyzstan.northElectric.HXF300.OverVoltagePresenter;

import cn.hexing.model.TranXADRAssist;


public class OverVoltageActivity extends RxMvpBaseActivity<OverVoltageContact.Presenter> implements OverVoltageContact.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_over_voltage);
    }
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.read_function_overvoltage));
    ...
    @Override
    public OverVoltageContact.Presenter createPresenter() {
        return new OverVoltagePresenter(this);
    }

    @Override
    public void showData(TranXADRAssist item) {
        if (item.obis.equals("3#1-0:12.44.0.255#02")) {
