...
import com.hx.read.contact.kyrgyzstan.northElectric.HXE310.VoltageUnbalanceContact;
import com.hx.read.presenter.kyrgyzstan.northElectric.HXE310.VoltageUnbalancePresenter;

import cn.hexing.model.TranXADRAssist;

public class VoltageUnbalanceActivity extends RxMvpBaseActivity<VoltageUnbalanceContact.Presenter> implements VoltageUnbalanceContact.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voltage_unbalance_threshold);
    }
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.read_function_voltage_unbalance_threshold));
    ...
    @Override
    public VoltageUnbalanceContact.Presenter createPresenter() {
        return new VoltageUnbalancePresenter(this);
    }

    @Override
    public void showData(TranXADRAssist item) {
        if (item.obis.equals("3#1-0:12.133.0.255#02")) {
