...
import com.hx.read.contact.kyrgyzstan.northElectric.HXE110.UnderVoltageContact;
import com.hx.read.presenter.kyrgyzstan.northElectric.HXE110.UnderVoltagePresenter;

import cn.hexing.model.TranXADRAssist;

public class UnderVoltageActivity extends RxMvpBaseActivity<UnderVoltageContact.Presenter> implements UnderVoltageContact.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_undervoltage);
    }
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.read_function_undervoltage));
    ...
    @Override
    public UnderVoltageContact.Presenter createPresenter() {
        return new UnderVoltagePresenter(this);
    }

    @Override
    public void showData(TranXADRAssist item) {
        if (item.obis.equals("3#1-0:12.43.0.255#02")) {
