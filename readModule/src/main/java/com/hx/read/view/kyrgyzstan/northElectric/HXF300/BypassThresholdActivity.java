...
import com.hx.read.contact.kyrgyzstan.northElectric.HXF300.BypassThresholdContact;
import com.hx.read.presenter.kyrgyzstan.northElectric.HXF300.BypassThresholdPresenter;

import cn.hexing.model.TranXADRAssist;

public class BypassThresholdActivity extends RxMvpBaseActivity<BypassThresholdContact.Presenter> implements BypassThresholdContact.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bypass_threshold);
    }
    ...
    public void initView() {
        ...
        headerLayout.showTitle(getString(R.string.read_function_bypass));
    ...
    @Override
    public BypassThresholdContact.Presenter createPresenter() {
        return new BypassThresholdPresenter(this);
    }

    @Override
    public void showData(TranXADRAssist item) {
        if (item.obis.equals("3#1-0:11.130.0.255#02")) {
