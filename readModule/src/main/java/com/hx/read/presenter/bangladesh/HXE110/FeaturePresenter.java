...
import com.hx.read.contact.bangladesh.HXE110.FeaturesContact;
import com.hx.read.view.bangladesh.read.HXE110_KP.DayFreezeActivity;
import com.hx.read.view.bangladesh.read.HXE110_KP.DemandActivity;
import com.hx.read.view.bangladesh.read.HXE110_KP.EnergyActivity;
import com.hx.read.view.bangladesh.read.HXE310_KP.EventRecordActivity;
import com.hx.read.view.bangladesh.read.HXE110_KP.InstantaneousActivity;
import com.hx.read.view.bangladesh.read.HXE110_KP.MonthFreezeActivity;
import com.hx.read.view.bangladesh.read.HXE310_KP.PrepaymentActivity;
import com.hx.read.view.bangladesh.read.HXE110_KP.SettingActivity;
...
public class FeaturePresenter extends RxBasePresenterImpl<FeaturesContact.View> implements FeaturesContact.Presenter{
    ...
    public void getShowList() {
        ...
        item = new FeaturesMenuBean();
        item.setResourceIdName(R.string.read_set);
        item.setSort(12);
        item.imgResId = R.mipmap.img_time_set;
        item.setCls(SettingActivity.class);
        dataList.add(item);
