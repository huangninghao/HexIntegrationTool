...
public class OverVoltagePresenter extends RxBasePresenterImpl<OverVoltageContact.View> implements OverVoltageContact.Presenter {
    private HexClientAPI clientAPI;
    public OverVoltagePresenter(OverVoltageContact.View view) {
        super(view);
    ...
    public void readThreshold() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.obis = "3#1-0:12.35.0.255#02";
    ...
    public void readTime() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                TranXADRAssist actionAssist = new TranXADRAssist();
                actionAssist.obis = "3#1-0:12.44.0.255#02";
