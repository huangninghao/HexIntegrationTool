...
import com.hx.read.contact.kyrgyzstan.northElectric.HXF300.PLCContact;
    ...
    public void readPLC() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.obis = "1#1-2:0.2.0.255#00";
                actionAssist.dataType = HexDataFormat.OCTET_STRING_ASCS;
