...
import com.hx.read.contact.kyrgyzstan.northElectric.HXE110.CurrentUnbalanceContact;
...
public class CurrentUnbalancePresenter extends RxBasePresenterImpl<CurrentUnbalanceContact.View> implements CurrentUnbalanceContact.Presenter{
    private HexClientAPI clientAPI;

    public CurrentUnbalancePresenter(CurrentUnbalanceContact.View view) {
        super(view);
    ...
    public void readThreshold() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.obis = "3#1-0:11.39.0.255#02";
    ...
    public void setThreshold(final String threshold) {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.dataType = LONG_UNSIGNED;
                actionAssist.scale = 1;
                String data =  Float.parseFloat(threshold) * Math.pow(10, actionAssist.scale) + "";
    ...
    public void readTime() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                TranXADRAssist actionAssist = new TranXADRAssist();
                actionAssist.obis = "3#1-0:11.41.0.255#02";
