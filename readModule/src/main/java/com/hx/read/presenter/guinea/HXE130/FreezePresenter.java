...
import com.hx.read.contact.guinea.HXE130.FreezeContact;
...
public class FreezePresenter extends RxBasePresenterImpl<FreezeContact.View> implements FreezeContact.Presenter {
    ...
    public void getShowList(final TranXADRAssist assiste) {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                if (actionAssist.obis.equals(ObisUtil.METER_DAILY_FREEZE_POWER_INFORMATION)) {
                ...
                } else if (actionAssist.obis.equals(ObisUtil.METER_DAY_FREEZE_PREPAID)) {
                    ...
                    public void onSuccess(List<TranXADRAssist> data) {
                        if (data.size()>0) {
                            ...
                            HexThreadManager.runTaskOnMainThread(new Runnable() {
                                ...
                                public void run() {
                                    getView().hideLoading();
                                    ToastUtils.showToast(ReadApp.getInstance(),ReadApp.getInstance().getString(R.string.emptyData));
                                }
                            });
                        }
                    }
    ...
    public boolean saveMeterFreezeData(List<TranXADRAssist> obisListData, String meterNo) {
        ...
        try {
            ...
            mStringBuilder.append("MeterDayFreezeData");
            mStringBuilder.append("\n");
