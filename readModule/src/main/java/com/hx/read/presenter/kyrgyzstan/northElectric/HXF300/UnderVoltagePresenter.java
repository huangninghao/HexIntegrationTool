...
public class UnderVoltagePresenter extends RxBasePresenterImpl<UnderVoltageContact.View> implements UnderVoltageContact.Presenter {
    private HexClientAPI clientAPI;

    public UnderVoltagePresenter(UnderVoltageContact.View view) {
        super(view);
    ...
    public void readThreshold() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.obis = "3#1-0:12.31.0.255#02";
    ...
    public void readTime() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                TranXADRAssist actionAssist = new TranXADRAssist();
                actionAssist.obis = "3#1-0:12.43.0.255#02";
