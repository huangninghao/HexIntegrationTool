...
public class VoltageUnbalancePresenter extends RxBasePresenterImpl<VoltageUnbalanceContact.View> implements VoltageUnbalanceContact.Presenter {
    private HexClientAPI clientAPI;

    public VoltageUnbalancePresenter(VoltageUnbalanceContact.View view) {
        super(view);
    ...
    public void readThreshold() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                actionAssist.obis = "3#1-0:12.132.0.255#02";
    ...
    public void readTime() {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                TranXADRAssist actionAssist = new TranXADRAssist();
                actionAssist.obis = "3#1-0:12.133.0.255#02";
