...
import com.hx.read.contact.southAfrica.HXE330.PrepaidPacketContact;
...
public class PrepaidPacketPresenter extends RxBasePresenterImpl<PrepaidPacketContact.View> implements PrepaidPacketContact.Presenter {
    ...
    private void initData() {
        ...
        ActivePowerPositive.name = "Active power (+)";
                    ...
                    public void onSuccess(TranXADRAssist data, int pos) {
                        if (data.aResult) {
                            ...
                            for (TranXADRAssist.StructBean assist : newData.structList) {
                                //继电器状态
                                if (assist.name.equals("Output state of relay")) {
                                ...
                                } else if (assist.name.equals("Relay Model")) {
                                    if (assist.value.equals("00")) {
                                ...
                                } else if (assist.name.equals("Meter Work Mode")) {
                                    if (assist.value.equals("00")) {
                                ...
                                } else if (assist.name.equals("Meter Status")) {
                                ...
                                } else if (assist.name.equals("Relay operate reson")) {
