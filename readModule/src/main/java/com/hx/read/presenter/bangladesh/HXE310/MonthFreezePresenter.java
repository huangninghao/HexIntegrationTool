...
import com.hx.read.contact.bangladesh.HXE310.MonthFreezeContact;
    ...
    public void getMonthFreeze(final String startTime, final String endTime, final int type) {
        ...
        HexThreadManager.singleThreadPoolRun(new Runnable() {
            ...
            public void run() {
                ...
                switch (type) {
                    case 0:
                        OBIS = ObisUtil.HXT300_METER_MONTHLY_FREEZE_POWER_INFORMATION;
                        break;
                    case 1:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_PREPAYMENT_INFORMATION;
                        break;
                    case 2:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_SPECIAL_INFORMATION;
                        break;
                    case 3:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_POSITIVE_ACTIVE_ENERGY;
                        break;
                    case 4:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_REVERSE_ACTIVE_ENERGY;
                        break;
                    case 5:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_POSITIVE_REACTIVE_ENERGY;
                        break;
                    case 6:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_REVERSE_REACTIVE_ENERGY;
                        break;
                    case 7:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_CONSUMPTION_INFORMATION;
                        break;
                    case 8:
                        OBIS = ObisUtil.HXE310_KP_METER_MONTHLY_FREEZE_PFC_DEDUCTION_AMOUNT;
                        break;
    ...
    private TranXADRAssist getMonthlyFreezeXAD(int type,String OBIS,String startTime,String endTime) {
        ...
        switch (type) {
            ...
            case 6:
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive energy";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 1 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 2 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 3 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 4 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 5 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 6 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 7 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                ...
                item.unit = "kvarh";
                item.scale = -2;
                item.name = "Reverse reactive rate 8 electricity";
                item.dataType = HexDataFormat.DOUBLE_LONG;
                result.add(item);
                //endregion description
                break;
